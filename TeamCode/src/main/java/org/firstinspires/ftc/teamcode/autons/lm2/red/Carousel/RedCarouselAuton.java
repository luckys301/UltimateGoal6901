        ...
        schedule(
                new SelectCommand(new HashMap<Object, Command>() {{
                    put(TeamMarkerPipeline.Position.LEFT, new SequentialCommandGroup(
                            new RedCarouselCommandL(drivetrain, intake, lift, shooterFlipper, carousel))
                    );
                    put(TeamMarkerPipeline.Position.MIDDLE, new SequentialCommandGroup(
                            new RedCarouselCommandC(drivetrain, intake, lift, shooterFlipper, carousel))
                    );
                    put(TeamMarkerPipeline.Position.RIGHT, new SequentialCommandGroup(
                            new RedCarouselCommandR(drivetrain, intake, lift, shooterFlipper, carousel))
                    );
