...
//                .whenPressed(new SharedDropFreightCommand(shooterFlipper,drivetrain));
...
//                .whileHeld(wobbleGoal::subtractToCap));
//
